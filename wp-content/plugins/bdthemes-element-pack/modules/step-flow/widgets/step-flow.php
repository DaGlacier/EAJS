	...
	protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'solid',
                'selectors' => [
                    '{{WRAPPER}} .bdt-step-flow-direction, {{WRAPPER}} .bdt-step-flow-direction:after' => 'border-top-style: {{VALUE}};',
                    '{{WRAPPER}} .bdt-step-flow-direction:after' => 'border-right-style: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .bdt-step-flow-direction' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'render_type' => 'ui',
                'selectors' => [
                    '{{WRAPPER}} .bdt-step-flow-direction' => 'top: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'render_type' => 'ui',
                'selectors' => [
                    '{{WRAPPER}} .bdt-step-flow-direction' => 'right: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .bdt-step-flow-direction' => 'border-color: {{VALUE}};',
                    '{{WRAPPER}} .bdt-step-flow-direction:after' => 'border-color: {{VALUE}};',
                ],
            ]
        );
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'step-flow' ); ?>>
            ...
            <?php if ( $settings['show_indicator'] === 'yes' ) : ?>
                <div class="bdt-step-flow-direction"></div>
            <?php endif; ?>
