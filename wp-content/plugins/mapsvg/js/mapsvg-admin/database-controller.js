(function($, window){
    ...
    MapSVGAdminDatabaseController.prototype.viewLoaded = function() {
        var _this = this;
        // this.controllers.source      = new MapSVGAdminDatabaseListController('mapsvg-data-source', _this.admin, _this.mapsvg);
    ...
    MapSVGAdminDatabaseController.prototype.loadDataSourceController = function (){
        ...
        // _this.dataSourceContainer = $('<div class="mapsvg-modal-edit" id="mapsvg-data-source-container"></div>');

        // this.contentView.append(_this.dataSourceContainer);
        // _this.dataSourceContainer.html('test');
        this.contentView.css({transform: 'translateX(100%)'});
        _this.admin.loadController('mapsvg-data-source-container', 'databaseSource');
    };
