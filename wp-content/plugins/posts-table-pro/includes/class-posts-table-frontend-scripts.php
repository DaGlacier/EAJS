...
class Posts_Table_Frontend_Scripts {
    ...
    public static function register_styles() {
        ...
        wp_register_style( 'photoswipe', Posts_Table_Util::get_asset_url( "css/photoswipe/photoswipe.min.css" ), array(), '4.1.1' );
        wp_register_style( 'photoswipe-default-skin', Posts_Table_Util::get_asset_url( "css/photoswipe/default-skin/default-skin.min.css" ), array( 'photoswipe' ), '4.1.1' );

        wp_register_style( self::SCRIPT_HANDLE, Posts_Table_Util::get_asset_url( "css/ptp-combined.min.css" ), array(), self::SCRIPT_VERSION );
    ...
    public static function register_scripts() {
        ...
        if ( ! wp_script_is( 'photoswipe', 'registered' ) ) {
            wp_register_script( 'photoswipe', Posts_Table_Util::get_asset_url( "js/photoswipe/photoswipe.min.js" ), array(), '4.1.1', true );
        }
        if ( ! wp_script_is( 'photoswipe-ui-default', 'registered' ) ) {
            wp_register_script( 'photoswipe-ui-default', Posts_Table_Util::get_asset_url( "js/photoswipe/photoswipe-ui-default.min.js" ), array( 'photoswipe' ), '4.1.1', true );
        }

        wp_register_script( self::SCRIPT_HANDLE, Posts_Table_Util::get_asset_url( "js/ptp-combined.min.js" ), array(), self::SCRIPT_VERSION, true );
