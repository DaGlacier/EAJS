...
final class Posts_Table_Pro_Plugin {
    ...
    private function includes() {
        $root_path = plugin_dir_path( self::FILE );

        // License
        require_once $root_path . 'license/class-b2-plugin-license.php';

        // Lib
        require_once $root_path . 'lib/class-html-data-table.php';
        require_once $root_path . 'lib/class-wp-scoped-hooks.php';
        require_once $root_path . 'lib/class-wp-settings-api-helper.php';
